...
#### <a name="learned"></a> What I have learned today.

We should spell "project" as "projekt" because it sounds much cooler. Also, I learned a bit more about how to add remote access paths to other repositories, which I haven't really worked with in the past because most of my GitHub work has been only with myself. :)
